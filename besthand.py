...
class BestHand:
	...
	def bestHand(self):
		if(self.__straightFlush == True):
			...
			self.__winningHand = [self.__quadra[len(self.__quadra)-4], self.__quadra[len(self.__quadra)-3], self.__quadra[len(self.__quadra)-2], self.__quadra[len(self.__quadra)-1]]
			...
			self.__winningHand = [self.__trinca[len(self.__trinca)-3], self.__trinca[len(self.__trinca)-2], self.__trinca[len(self.__trinca)-1]]
			n = len(self.__playerTable) - 1
			m = 0
			while(n > 0):
				if(self.__playerTable[n] not in self.__winningHand):
			...
			self.__winningHand = [self.__doisPares[len(self.__doisPares)-4], self.__doisPares[len(self.__doisPares)-3], self.__doisPares[len(self.__doisPares)-2], self.__doisPares[len(self.__doisPares)-1]]
			n = len(self.__playerTable) - 1
			while(n > 0):
				if(self.__playerTable[n] not in self.__winningHand):
					self.__winningHand.append(self.__playerTable[n])
			...
			self.__winningHand = [self.__par[len(self.__par)-2], self.__par[len(self.__par)-1]]
			n = len(self.__playerTable) - 1
			m = 0
			while(n > 0):
				if(self.__playerTable[n] not in self.__winningHand):
			...
			self.__winningHand = [self.__playerTable[len(self.__playerTable)-5], self.__playerTable[len(self.__playerTable)-4], self.__playerTable[len(self.__playerTable)-3], self.__playerTable[len(self.__playerTable)-2], self.__playerTable[len(self.__playerTable)-1]]
			return(self.__winningHand)
